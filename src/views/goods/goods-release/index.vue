<template lang="">
  <div class="block">
  <el-timeline>
    <el-timeline-item timestamp="选择商品品类" placement="top">
      <el-card stype="padding:18px;">
        <el-cascader-panel :options="options" @change="cascaderChange" v-model="cascaderList"></el-cascader-panel>
      </el-card>
    </el-timeline-item>
    <el-timeline-item timestamp="填写商品详情" placement="top">
      <el-card>
  ...
  <el-form-item>
    ...
    <el-timeline-item timestamp="商品发布成功" placement="top">
      <el-card>
...
export default {
  ...
  methods:{
    cascaderChange (v) {
      console.log(v,this.cascaderList)
    },
     //移除图片功能
